...
private:
    ...
    {
    public:
        Node(int id, float priority) : index(id), data(StudentProfile(id)), priority(priority) {}
        Node(int id, float priority, Node *parent) : index(id), data(StudentProfile(id)), priority(priority), parent(parent) {}
        Node *parent = nullptr;
